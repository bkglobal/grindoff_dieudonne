...
export const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>((props, ref) => {
  ...
  const classes = classNames(
    {
      ['w-full text-base rounded focus:outline-none border py-2 px-3 focus-within:border-info focus-within:shadow-spread-info']: true,
      ['resize']: resize,
      ['bg-white border-alert focus-within:border-alert focus-within:shadow-spread-alert']: error,
    },
    className
  );
