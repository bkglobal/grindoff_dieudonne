...
import UploadDocsModal from './common/UploadDocsModal';

const AccountPage = () => {
  const [activeTab, setActiveTab] = useState<'profile' | 'id_verification'>('profile');
  const [openUploadModal, setOpenUploadModal] = useState(false);
  const [activeUpload, setActiveUpload] = useState<'' | 'gov' | 'nin' | 'bank' | 'bvn'>('');

  return (
    <>
      <UploadDocsModal name={activeUpload} open={openUploadModal} onClose={() => setOpenUploadModal(false)} />
          ...
          <Card className="my-6 xx:border-none xx:px-3 md:px-6 py-8">
            ...
            <div className="grid grid-cols-2 gap-8 mt-16">
              <div
                ...
                className="bg-body-grey-lightest flex items-center h-20 p-2 cursor-pointer"
              >
              ...
              <div className="bg-body-grey-lightest flex items-center h-20 p-2 cursor-pointer">
                <div className="h-full w-16 rounded-sm flex justify-center items-center bg-primary-lightest mr-8">
